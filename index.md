...
On the **networked computer**, download the latest stable release (v3.1.8 as of latest update of this guide) from [GitHub](https://github.com/anza-xyz/agave/releases/latest). Look for the Linux prebuilt binary: `solana-release-x86_64-unknown-linux-gnu.tar.bz2`.
